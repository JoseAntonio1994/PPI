...
<body>
 ...
 <div class="container">
    ...
    <div class="form-group row">
        <label class="col-sm-2">Nombre de la empresa:</label>
        <div class="col-md-4">
            <input id="estado" type="text" class="form-control" name="estado" required autocomplete="estado" autofocus>
        </div>
    ...
    <div class="form-group row">
        <label class="col-sm-2">Domicilio de la empresa:</label>
        <div class="col-md-4">
            <input id="estado" type="text" class="form-control" name="estado" required autocomplete="estado" autofocus>
        </div>
        <label class="col-sm-2">RFC de la empresa:</label>
        <div class="col-md-4">
            <input id="estado" type="text" class="form-control" name="estado" required autocomplete="estado" autofocus>
        </div>
    </div>
    <div class="form-group row">
        <label class="col-sm-2">Código postal de la empresa:</label>
        <div class="col-md-4">
            <input id="estado" type="text" class="form-control" name="estado" required autocomplete="estado" autofocus>
        </div>
        <label class="col-sm-2">Teléfono de la empresa:</label>
        <div class="col-md-4">
            <input id="estado" type="text" class="form-control" name="estado" required autocomplete="estado" autofocus>
        </div>
    </div>
